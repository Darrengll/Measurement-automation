...
class SpcmAdcM4x:
    ...
    def show_channel(self, channels, ampl, time_from, time_until):
        ...
        SpcmAdcM4x.plot_signal(channels, data, ampl, time_from, time_until,
    ...
    def show_spectrum(self, channels, ampl, memsize, pretrigger, freq_from,
        ...
        SpcmAdcM4x.plot_spectrum(channels, data, freq_from, freq_until,
                                 self.get_sample_rate())
    ...
    def show_averaged_spectrum(self, channels, ampl, n_seg,
        ...
        SpcmAdcM4x.plot_spectrum(channels, data_cut, freq_from, freq_until,
                                 self.get_sample_rate())
        return data_cut
