...
class SpinEchoTestCase(KtQetExperimentTestCase):
    ...
    def setUp(self):
        ...
        self.experiment = SpinEcho(self.qubit)
    ...
    def test_run(self):
        ...
        try:
            ...
            self.assertEqual(str(e), 'Pi/2 waveforms not configured.')
...
def suite():
    ...
    suite.addTests(unittest.TestLoader().loadTestsFromTestCase(SpinEchoTestCase))
    return suite
